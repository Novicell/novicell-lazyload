...
},{"./isObject":"../node_modules/lodash/isObject.js","./now":"../node_modules/lodash/now.js","./toNumber":"../node_modules/lodash/toNumber.js"}],"novicell.dynamic-image.js":[function(require,module,exports) {
'use strict';
/**
...
exports.dynamicImage = void 0;

var dynamicImage = function dynamicImage() {
  function getUrl(el) {
...
},{}],"lazy-images.js":[function(require,module,exports) {
'use strict';
/**
* @name Novicell Dynamic Image
* @author Jonas Havmøller & Danni Larsen
...
var _novicell = require("./novicell.dynamic-image");
...
var NovicellLazyLoad = {
  lazyLoad: function lazyLoad(e) {
    ...
    if (setMeasuredUrl) {
      ...
      var url = (0, _novicell.dynamicImage)().getUrl(target);
      ...
      srcset.forEach(function (src) {
        ...
        var url = src[0];
        var bp = src[1];
        var newSrc = (0, _novicell.dynamicImage)().queryUrl(url, query); // set new srcset

        newSrcset.push(newSrc + ' ' + bp);
      });
      target.setAttribute('srcset', newSrcset.join(', '));
      target.setAttribute('src', (0, _novicell.dynamicImage)().queryUrl(src, query));
    } else if (setSrc) {
      var query = target.getAttribute('data-query-obj');
      var src = target.getAttribute('data-src');
      var url = (0, _novicell.dynamicImage)().queryUrl(src, query);
...
window.addEventListener('resize', (0, _debounce.default)(NovicellLazyLoad.checkImages), 100, false);
},{"lazysizes":"../node_modules/lazysizes/lazysizes.js","lodash/debounce":"../node_modules/lodash/debounce.js","./novicell.dynamic-image":"novicell.dynamic-image.js"}]},{},["lazy-images.js"], null)

...
(function(L) {
  (function(h, f) {
    ...
    function(f, i, v) {
      ...
      var N = i.documentElement, H = f.HTMLPictureElement, I = "addEventListener", b = "getAttribute", C = f[I].bind(f), o = f.setTimeout, U = f.requestAnimationFrame || o, m = f.requestIdleCallback, W = /^picture$/i, E = ["load", "error", "lazyincluded", "_lazyloaded"], S = {}, G = Array.prototype.forEach, q = function(a, r) {
        ...
        var a, r, s, y, p, l, z, c, g, R, w, J, xt = /^img$/i, Lt = /^iframe$/i, Nt = "onscroll" in f && !/(gle|ing)bot/.test(navigator.userAgent), Wt = 0, at = 0, k = 0, Z = -1, ht = function(e) {
          k--, (!e || k < 0 || !e.target) && (k = 0);
        }, pt = function(e) {
          return J == null && (J = V(i.body, "visibility") == "hidden"), J || !(V(e.parentNode, "visibility") == "hidden" && V(e, "visibility") == "hidden");
        }, $t = function(e, n) {
          var d, A = e, x = pt(e);
          for (c -= n, w += n, g -= n, R += n; x && (A = A.offsetParent) && A != i.body && A != N; )
            x = (V(A, "opacity") || 1) > 0, x && V(A, "overflow") != "visible" && (d = A.getBoundingClientRect(), x = R > d.left && g < d.right && w > d.top - 1 && c < d.bottom + 1);
          return x;
        }, yt = function() {
          var e, n, d, A, x, $, P, B, j, T, Q, tt, M = u.elements;
          if ((y = t.loadMode) && k < 8 && (e = M.length)) {
            for (n = 0, Z++; n < e; n++)
              if (!(!M[n] || M[n]._lazyRace)) {
                if (!Nt || u.prematureUnveil && u.prematureUnveil(M[n])) {
                  it(M[n]);
                  continue;
                }
                if ((!(B = M[n][b]("data-expand")) || !($ = B * 1)) && ($ = at), T || (T = !t.expand || t.expand < 1 ? N.clientHeight > 500 && N.clientWidth > 500 ? 500 : 370 : t.expand, u._defEx = T, Q = T * t.expFactor, tt = t.hFac, J = null, at < Q && k < 1 && Z > 2 && y > 2 && !i.hidden ? (at = Q, Z = 0) : y > 1 && Z > 1 && k < 6 ? at = T : at = Wt), j !== $ && (l = innerWidth + $ * tt, z = innerHeight + $, P = $ * -1, j = $), d = M[n].getBoundingClientRect(), (w = d.bottom) >= P && (c = d.top) <= z && (R = d.right) >= P * tt && (g = d.left) <= l && (w || R || g || c) && (t.loadHidden || pt(M[n])) && (r && k < 3 && !B && (y < 3 || Z < 4) || $t(M[n], $))) {
                  if (it(M[n]), x = !0, k > 9)
                    break;
                } else
                  !x && r && !A && k < 4 && Z < 4 && y > 2 && (a[0] || t.preloadAfterLoad) && (a[0] || !B && (w || R || g || c || M[n][b](t.sizesAttr) != "auto")) && (A = a[0] || M[n]);
              }
            A && !x && it(A);
          }
        ...
        }, Mt = nt(function(e, n, d, A, x) {
          var $, P, B, j, T, Q;
          (T = D(e, "lazybeforeunveil", n)).defaultPrevented || (A && (d ? F(e, t.autosizesClass) : e.setAttribute("sizes", A)), P = e[b](t.srcsetAttr), $ = e[b](t.srcAttr), x && (B = e.parentNode, j = B && W.test(B.nodeName || "")), Q = n.firesLoad || "src" in e && (P || $ || j), T = { target: e }, F(e, t.loadingClass), Q && (clearTimeout(s), s = o(ht, 2500), K(e, zt, !0)), j && G.call(B.getElementsByTagName("source"), It), P ? e.setAttribute("srcset", P) : $ && !j && (Lt.test(e.nodeName) ? _t(e, $) : e.src = $), x && (P || j) && et(e, { src: $ })), e._lazyRace && delete e._lazyRace, Y(e, t.lazyClass), rt(function() {
          ...
          if (!e._lazyRace) {
            var n, d = xt.test(e.nodeName), A = d && (e[b](t.sizesAttr) || e[b]("sizes")), x = A == "auto";
            (x || !r) && d && (e[b]("src") || e.srcset) && !e.complete && !q(e, t.errorClass) && q(e, t.lazyClass) || (n = D(e, "lazyunveilread").detail, x && ct.updateElem(e, !0, e.offsetWidth), e._lazyRace = !0, k++, Mt(e, n, x, A, d));
          }
        }, Ut = vt(function() {
          t.loadMode = 3, _();
        }), mt = function() {
        ...
        return {
          _: function() {
            ...
            }), f.MutationObserver ? new MutationObserver(_).observe(N, { childList: !0, subtree: !0, attributes: !0 }) : (N[I]("DOMNodeInserted", _, !0), N[I]("DOMAttrModified", _, !0), setInterval(_, 999)), C("hashchange", _, !0), ["focus", "mouseover", "click", "load", "transitionend", "animationend"].forEach(function(e) {
              i[I](e, _, !0);
        ...
        var a, r = nt(function(l, z, c, g) {
          var R, w, J;
          if (l._lazysizesWidth = g, g += "px", l.setAttribute("sizes", g), W.test(z.nodeName || ""))
...
let dt = 0;
const At = 50, O = window.devicePixelRatio;
class qt {
  constructor({ includeWebp: h = !0, includeRetina: f = !0 }) {
    this.includeWebp = h, this.includeRetina = f, this.lazyLoad = function(i) {
      ...
      const v = this.includeWebp, u = this.includeRetina, t = i.target, N = t.classList.contains("lazyload-measure") || t.classList.contains("lazyload-bg"), H = t.classList.contains("lazyload-measure"), I = t.hasAttribute("data-srcset") && t.hasAttribute("data-query-obj"), b = t.hasAttribute("data-src") && t.hasAttribute("data-query-obj");
      if (N && i.preventDefault(), H) {
        const C = t.classList.contains("lazyload-bg");
        let o = lt().getUrl(t);
        Ct(function(U) {
          if (U && v && (o = Et(o)), C && u) {
            const { orgWidth: m, orgHeight: W, retinaHeight: E, retinaWidth: S } = ut(o);
            t.parentNode.style.backgroundImage = `url(${o})`, window.CSS.supports("background-image", `-webkit-image-set( url(${o}) 1x, url(${X({ url: o, orgWidth: m, orgHeight: W, retinaHeight: E, retinaWidth: S })}) ${O}x)`) && (t.parentNode.style.backgroundImage = `-webkit-image-set( url(${o}) 1x, url(${X({ url: o, orgWidth: m, orgHeight: W, retinaHeight: E, retinaWidth: S })}) ${O}x)`), window.CSS.supports("background-image", `image-set(url("${o}") 1x, url(${X({ url: o, orgWidth: m, orgHeight: W, retinaHeight: E, retinaWidth: S })}) ${O}x)`) && (t.parentNode.style.backgroundImage = `image-set(url("${o}") 1x, url(${X({ url: o, orgWidth: m, orgHeight: W, retinaHeight: E, retinaWidth: S })}) ${O}x)`), t.style.visibility = "hidden";
          } else if (C)
            t.parentNode.style.backgroundImage = `url(${o})`, t.style.visibility = "hidden";
          else if (t.src = o, u) {
            const { orgWidth: m, orgHeight: W, retinaHeight: E, retinaWidth: S } = ut(o);
            (m || W) && t.setAttribute("srcset", `${o} 1x, ${X({ url: o, orgWidth: m, orgHeight: W, retinaHeight: E, retinaWidth: S })} ${O}x`);
          }
        });
      } else if (I) {
        ...
        Ct(function(W) {
          o.forEach(function(E) {
            ...
            if (W && v && (q = Et(q)), m.push(q + " " + G), u) {
              const F = G.match(/\d+/g), { orgWidth: Y, orgHeight: K, retinaHeight: D, retinaWidth: et } = ut(q), V = typeof Number(F) == "number" ? G.replace(F, (Number(F) * O).toString()) : G;
        ...
        if (u) {
          ...
          (m || W) && t.setAttribute("srcset", `${U} 1x, ${X({ url: U, orgWidth: m, orgHeight: W, retinaHeight: E, retinaWidth: S })} ${O}x`);
        }
...
function ut(L) {
  ...
  const i = f.get("width"), v = f.get("height"), u = typeof Number(i) == "number" ? (Number(i) * O).toString() : i, t = typeof Number(v) == "number" ? (Number(v) * O).toString() : v;
  return {
    orgWidth: i,
    orgHeight: v,
    retinaWidth: u,
